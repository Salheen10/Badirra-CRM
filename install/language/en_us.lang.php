...
$mod_strings = array(
    ...
    'LBL_SYSOPTS_2' => 'What type of database will be used for the Badirra CRM instance you are about to install?',
    ...
    'ERR_ADMIN_USER_NAME_BLANK' => 'Provide the user name for the Badirra CRM admin user. ',
    'ERR_ADMIN_PASS_BLANK' => 'Provide the password for the Badirra CRM admin user. ',

    'ERR_CHECKSYS' => 'Errors have been detected during compatibility check. In order for your Badirra CRM Installation to function properly, please take the proper steps to address the issues listed below and either press the recheck button, or try installing again.',
    'ERR_CHECKSYS_CALL_TIME' => 'Allow Call Time Pass Reference is On (this should be set to Off in php.ini)',
    'ERR_CHECKSYS_CURL' => 'Not found: Badirra CRM Scheduler will run with limited functionality.',
    ...
    'ERR_CHECKSYS_PHP_INVALID_VER' => 'Your version of PHP is not supported by Badirra CRM. You will need to install a version that is compatible with the Badirra CRM application. Please consult the Compatibility Matrix in the Release Notes for supported PHP Versions. Your version is ',
    'ERR_CHECKSYS_IIS_INVALID_VER' => 'Your version of IIS is not supported by Badirra CRM. You will need to install a version that is compatible with the Badirra CRM application. Please consult the Compatibility Matrix in the Release Notes for supported IIS Versions. Your version is ',
    'ERR_CHECKSYS_FASTCGI' => 'We detect that you are not using a FastCGI handler mapping for PHP. You will need to install/configure a version that is compatible with the Badirra CRM application. Please consult the Compatibility Matrix in the Release Notes for supported Versions. Please see <a href="http://www.iis.net/php/" target="_blank">http://www.iis.net/php/</a> for details ',
    ...
    'LBL_CHECKSYS_XML_NOT_AVAILABLE' => 'Functions associated with XML Parser Libraries that are needed by the Badirra CRM application were not found. You might need to uncomment the extension in the  php.ini file, or recompile with the right binary file, depending on your version of PHP. Please refer to your PHP Manual for more information.',
    'ERR_CHECKSYS_MBSTRING' => 'Functions associated with the Multibyte Strings PHP extension (mbstring) that are needed by the Badirra CRM application were not found. <br/><br/>Generally, the mbstring module is not enabled by default in PHP and must be activated with --enable-mbstring when the PHP binary is built. Please refer to your PHP Manual for more information on how to enable mbstring support.',
    ...
    'ERR_CHECKSYS_JSON_NOT_AVAILABLE' => "Functions associated with JSON Parser Libraries that are needed by the Badirra CRM application were not found. You might need to uncomment the extension in the php.ini file, or recompile with the right binary file, depending on your version of PHP. Please refer to your PHP Manual for more information.",
    'LBL_CHECKSYS_OVERRIDE_CONFIG' => 'Config override',
    'ERR_CHECKSYS_SAFE_MODE' => 'Safe Mode is On (you may wish to disable in php.ini)',
    'ERR_CHECKSYS_ZLIB' => 'ZLib support not found: Badirra CRM reaps enormous performance benefits with zlib compression.',
    'ERR_CHECKSYS_ZIP' => 'ZIP support not found: Badirra CRM needs ZIP support in order to process compressed files.',
    'ERR_CHECKSYS_PCRE' => 'PCRE library not found: Badirra CRM needs PCRE library in order to process Perl style of regular expression pattern matching.',
    'ERR_CHECKSYS_PCRE_VER' => 'PCRE library version: Badirra CRM needs PCRE library 7.0 or above to process Perl style of regular expression pattern matching.',
    ...
    'ERR_DB_EXISTS_WITH_CONFIG' => 'Database already exists with config data. To run an install with the chosen database, please re-run the install and choose: "Drop and recreate existing Badirra CRM tables?". To upgrade, use the Upgrade Wizard in the Admin Console. Please read the upgrade documentation located <a href="https://docs.suitecrm.com/admin/installation-guide/upgrading/" target="_new">here</a>.',
    ...
    'ERR_DB_MYSQL_VERSION' => 'Your MySQL version (%s) is not supported by Badirra CRM. You will need to install a version that is compatible with the Badirra CRM application. Please consult the Compatibility Matrix in the Release Notes for supported MySQL versions.',
    ...
    'ERR_DB_PASSWORD' => 'The passwords provided for the Badirra CRM database administrator do not match. Please re-enter the same passwords in the password fields.',
    ...
    'ERR_DB_USER_EXISTS' => 'User name for Badirra CRM database user already exists -- cannot create another one with the same name. Please enter a new user name.',
    'ERR_DB_USER' => 'Enter a user name for the Badirra CRM database administrator.',
    'ERR_DBCONF_VALIDATION' => 'Please fix the following errors before proceeding:',
    'ERR_DBCONF_PASSWORD_MISMATCH' => 'The passwords provided for the Badirra CRM database user do not match. Please re-enter the same passwords in the password fields.',
    ...
    'ERR_PASSWORD_MISMATCH' => 'The passwords provided for the Badirra CRM admin user do not match. Please re-enter the same passwords in the password fields.',
    ...
    'ERR_PERFORM_NO_TCPIP' => '<b>We could not detect an Internet connection.</b> When you do have a connection, please visit <a href="https://www.suitecrm.com/">https://www.suitecrm.com/</a> to register with Badirra CRM. By letting us know a little bit about how your company plans to use Badirra CRM, we can ensure we are always delivering the right application for your business needs.',
    ...
    'ERR_URL_BLANK' => 'Provide the base URL for the Badirra CRM instance.',
    ...
    'LBL_CHECKSYS_CONFIG' => 'Writable Badirra CRM Configuration File (config.php)',
    ...
    'LBL_DBCONF_DB_PASSWORD' => 'Badirra CRM Database User Password',
    'LBL_DBCONF_DB_PASSWORD2' => 'Re-enter Badirra CRM Database User Password',
    'LBL_DBCONF_DB_USER' => 'Badirra CRM Database User',
    'LBL_DBCONF_SUITE_DB_USER' => 'Badirra CRM Database User',
    ...
    'LBL_DBCONFIG_SECURITY' => 'For security purposes, you can specify an exclusive database user to connect to the Badirra CRM database. This user must be able to write, update and retrieve data on the Badirra CRM database that will be created for this instance. This user can be the database administrator specified above, or you can provide new or existing database user information.',
    ...
    'LBL_DISABLED_HELP_1' => 'For installation help, please visit the Badirra CRM',
    'LBL_DISABLED_HELP_LNK' => 'https://community.suitecrm.com',
    'LBL_DISABLED_HELP_2' => 'support forums',
    'LBL_DISABLED_TITLE_2' => 'Badirra CRM Installation has been Disabled',
    'LBL_HELP' => 'Help',
    'LBL_INSTALL' => 'Install',
    ...
    'LBL_LANG_1' => 'To use a language in Badirra CRM other than the default language (US-English), you can upload and install the language pack at this time. You will be able to upload and install language packs from within the Badirra CRM application as well. If you would like to skip this step, click Next.',
    ...
    'LBL_LAUNCHING_SILENT_INSTALL' => 'Installing Badirra CRM now. This may take up to a few minutes.',
    ...
    'LBL_LICENSE_TITLE_2' => 'Badirra CRM License',
    ...
    'LBL_PERFORM_CONFIG_PHP' => 'Creating Badirra CRM configuration file',
    ...
    'LBL_PERFORM_CREATE_DEFAULT' => 'Creating default Badirra CRM data',
    ...
    'LBL_PERFORM_OUTRO_1' => 'The setup of Badirra CRM ',
    ...
    'LBL_PERFORM_TABLES' => 'Creating Badirra CRM application tables, audit tables and relationship metadata',
    'LBL_PERFORM_TITLE' => 'Perform Setup',
    'LBL_PRINT' => 'Print',
    'LBL_REG_CONF_1' => 'Please complete the short form below to receive product announcements, training news, special offers and special event invitations from Badirra CRM. We do not sell, rent, share or otherwise distribute the information collected here to third parties.',
    'LBL_REG_CONF_3' => 'Thank you for registering. Click on the Finish button to login to Badirra CRM. You will need to log in for the first time using the username "admin" and the password you entered in step 2.',
    'LBL_REG_TITLE' => 'Registration',

    'LBL_REQUIRED' => '* Required field',

    'LBL_SITECFG_ADMIN_Name' => 'Badirra CRM Application Admin Name',
    'LBL_SITECFG_ADMIN_PASS_2' => 'Re-enter Badirra CRM Admin User Password',
    'LBL_SITECFG_ADMIN_PASS' => 'Badirra CRM Admin User Password',
    'LBL_SITECFG_APP_ID' => 'Application ID',
    'LBL_SITECFG_CUSTOM_ID_DIRECTIONS' => 'If selected, you must provide an application ID to override the auto-generated ID. The ID ensures that sessions of one Badirra CRM instance are not used by other instances. If you have a cluster of Badirra CRM installations, they all must share the same application ID.',
    'LBL_SITECFG_CUSTOM_ID' => 'Provide Your Own Application ID',
    'LBL_SITECFG_CUSTOM_LOG_DIRECTIONS' => 'If selected, you must specify a log directory to override the default directory for the Badirra CRM log. Regardless of where the log file is located, access to it through a web browser will be restricted via an .htaccess redirect.',
    'LBL_SITECFG_CUSTOM_LOG' => 'Use a Custom Log Directory',
    'LBL_SITECFG_CUSTOM_SESSION_DIRECTIONS' => 'If selected, you must provide a secure folder for storing Badirra CRM session information. This can be done to prevent session data from being vulnerable on shared servers.',
    'LBL_SITECFG_CUSTOM_SESSION' => 'Use a Custom Session Directory for Badirra CRM',
    ...
    'LBL_SITECFG_URL' => 'URL of Badirra CRM Instance',
    'LBL_SITECFG_ANONSTATS' => 'Send Anonymous Usage Statistics?',
    'LBL_SITECFG_ANONSTATS_DIRECTIONS' => 'If selected, Badirra CRM will send <b>anonymous</b> statistics about your installation to Badirra CRM Inc. every time your system checks for new versions. This information will help us better understand how the application is used and guide improvements to the product.',
    'LBL_SITECFG_URL_MSG' => 'Enter the URL that will be used to access the Badirra CRM instance after installation. The URL will also be used as a base for the URLs in the Badirra CRM application pages. The URL should include the web server or machine name or IP address.',
    'LBL_SITECFG_SYS_NAME_MSG' => 'Enter a name for your system. This name will be displayed in the browser title bar when users visit the Badirra CRM application.',
    'LBL_SITECFG_PASSWORD_MSG' => 'After installation, you will need to use the Badirra CRM admin user (default username = admin) to log in to the Badirra CRM instance. Enter a password for this administrator user. This password can be changed after the initial login. You may also enter another admin username to use besides the default value provided.',
    ...
    'LBL_STEP' => 'Step',
    'LBL_TITLE_WELCOME' => 'Welcome to the Badirra CRM ',
    ...
    'REQUIRED_SYS_COMP_MSG' =>
        'Before you begin, please be sure that you have the supported versions of the following system components:<br>
                      ...
                      compatible system components for the Badirra CRM version that you are installing.<br>',
    'REQUIRED_SYS_CHK' => 'Initial System Check',
    'REQUIRED_SYS_CHK_MSG' =>
        'When you begin the installation process, a system check will be performed on the web server on which the Badirra CRM files are located in order to
                      ...
                      <li>The following Badirra CRM files must be writeable:<ul><li><b>/custom</li>
                      <li>/cache</li>
                      <li>/modules</li>
    ...
    'REQUIRED_INSTALLTYPE_MSG' =>
        'After the system check is performed, you can choose either
                      ...
                      <ul>
                      <li> <b>Type of database</b> that will house the Badirra CRM data <ul><li>Compatible database
                      ...
                      <ul><li>This may be <i>localhost</i> if the database is on your local computer or is on the same web server or machine as your Badirra CRM files.<br><br></li></ul></li>
                      <li><b>Name of the database</b> that you would like to use to house the Badirra CRM data</li>
                        <ul>
                          ...
                          be dropped during installation when the schema for the Badirra CRM database is defined.</li>
                      ...
                      <li> <b>Badirra CRM database user name and password</b>
                      </li>
                        <ul>
                      ...
                      <ul>
                      <li> <b>URL that will be used to access the Badirra CRM instance</b> after it is installed.
                      This URL should include the web server or machine name or IP address.<br><br></li>
                                  ...
                                  session directory for Badirra CRM information in order to prevent session data from
                                  being vulnerable on shared servers.<br><br></li>
                                  <li> [Optional] <b>Path to a custom log directory</b> if you wish to override the default directory for the Badirra CRM log.<br><br></li>
                                  <li> [Optional] <b>Application ID</b> if you wish to override the auto-generated
                                  ID that ensures that sessions of one Badirra CRM instance are not used by other instances.<br><br></li>
    ...
    'LBL_WIZARD_TITLE' => 'Badirra CRM Setup Wizard: ',
    'LBL_YES' => 'Yes',
    ...
    'LBL_SESSION_ERR_DESCRIPTION' => "Badirra CRM relies upon PHP sessions to store important information while connected to this web server. Your PHP installation does not have the Session information correctly configured.
    ...
    'LBL_REQUIRED_SYSTEM_NAME' => 'Provide a System Name for the Badirra CRM instance.',
...
$contact_user_link_guid',
    ...
    'LBL_OLD_PHP_MSG' => 'The recommended PHP version to install Badirra CRM is %s <br />The minimum PHP version required is %s<br />You are using PHP version %s, which is EOL: <a href="http://php.net/eol.php">http://php.net/eol.php</a>.<br />Please consider upgrading your PHP version. ',
    ...
    'LBL_DBCONFIG_MSG3' => 'Name of the database that will contain the data for the Badirra CRM instance you are about to install.',
    ...
    'LBL_DBCONFIG_B_MSG1' => 'The username and password of a database administrator who can create database tables and users and who can write to the database is necessary in order to set up the Badirra CRM database.'
);
