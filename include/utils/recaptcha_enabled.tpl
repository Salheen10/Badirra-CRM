...
{literal}
    ...
    /**
     * Callback to handle when Badirra CRM has responded to the browser
    ...
    /**
     * Send recaptcha response to Badirra CRM with the user's details from the login screen
    ...
    /**
     * Send recaptcha response to Badirra CRM with the user's details from the change password screen
     * @return {boolean}
     */
