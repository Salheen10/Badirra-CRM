...
$mod_strings = array(
    ...
    'ERR_CREDENTIALS_MISSING' => 'Your Badirra CRM credentials are missing.',
    ...
    'HDR_LOGIN_PANEL' => 'Please enter your Badirra CRM Login credentials.',
    'HEARTBEAT_MESSAGE' => "<BR>The Badirra CRM Updates mechanism allows your server to check to see if an update for your version of Badirra CRM is available.",
    ...
    'LBL_BACKUP_DIRECTORY_WRITABLE' => 'Must be writable by Badirra CRM',
    ...
    'LBL_BACKUP_INSTRUCTIONS_1' => 'The purpose of this tool is to assist in creating backups of the Badirra CRM application files. (Database backups should also be performed regularly. Please refer to your database vendor\'s documentation for information on how to backup your database.)',
    'LBL_BACKUP_INSTRUCTIONS_2' => 'To backup your Badirra CRM application files in a .zip file, enter the following information:',
    'LBL_BACKUP_RUN_BACKUP' => 'Run Backup',
    'LBL_BACKUPS_TITLE' => 'Backups',
    'LBL_BACKUPS' => 'Backup Badirra CRM files',
    'LBL_BUG_TITLE' => 'Bugs',
    ...
    'LBL_CALENDAR_SYNC_DESCRIPTION' => 'Manage automatic two-way synchronization between Badirra CRM and external calendar systems (Google Calendar, Outlook, etc.).',
    ...
    'LBL_CALENDAR_SYNC_USER_SYNC_DESC' => 'For each user, the system compares events between Badirra CRM and their external calendar (Google, Outlook, etc.), identifying what needs to be created, updated, or deleted in both directions.',
    'LBL_CALENDAR_SYNC_MEETING_SYNC' => 'Event-Level Synchronization:',
    'LBL_CALENDAR_SYNC_MEETING_SYNC_DESC' => 'Individual calendar events are synchronized bidirectionally, ensuring changes made in either Badirra CRM or external calendars appear in both systems while respecting your conflict resolution settings.',
    ...
    'LBL_CALENDAR_SYNC_CONFLICT_INTERNAL_BASED' => 'Badirra CRM Priority (SuiteCRM always wins)',
    ...
    'LBL_CALENDAR_SYNC_ALLOW_INTERNAL_DELETION' => 'Auto-Delete Badirra CRM Events:',
    'LBL_CALENDAR_SYNC_ALLOW_INTERNAL_DELETION_DESC' => 'Automatically remove Badirra CRM events when their linked external calendar events are deleted (caution: this permanently removes data)',
    'LBL_CALENDAR_SYNC_ALLOW_EXTERNAL_DELETION' => 'Auto-Delete External Events:',
    'LBL_CALENDAR_SYNC_ALLOW_EXTERNAL_DELETION_DESC' => 'Automatically remove external calendar events when their linked Badirra CRM events are deleted (caution: affects external calendars)',
    ...
    'LBL_COULD_NOT_CONNECT' => 'Error: Could not connect to the Badirra CRM Server.
    ...
    'LBL_DIAGNOSTIC_CONFIGPHP' => 'Badirra CRM config.php',
    'LBL_DIAGNOSTIC_CUSTOMDIR' => 'Badirra CRM Custom directory',
    ...
    'LBL_DIAGNOSTIC_GETSUITELOG' => 'Getting Badirra CRM.log',
    ...
    'LBL_DIAGNOSTIC_SUITELOG' => 'Badirra CRM Log File',
    'LBL_DIAGNOSTIC_TITLE' => 'Diagnostic Tool',
    'LBL_DIAGNOSTIC_VARDEFS' => 'Badirra CRM schema output (VARDEFS)',
    ...
    'LBL_LDAP_HELP_TXT' => 'When LDAP authentication is enabled, passwords can only be handled through LDAP. None of the Badirra CRM Password Management feature settings will apply.',
    ...
    'LBL_MI_IN_DASHLETS' => 'Installing Badirra CRM Dashlet ',
    'LBL_MI_UN_DASHLETS' => 'Uninstalling Badirra CRM Dashlet ',
    ...
    'LBL_MODULE_LOADER' => 'Add or remove Badirra CRM modules, themes, language packs and other extensions',
    ...
    'LBL_PROXY_ON_DESC' => 'Use a proxy to access external information such as Badirra CRM updates.',
    ...
    'LBL_REBUILD_DASHLETS_DESC_SHORT' => 'Rebuilds the Badirra CRM Dashlets cache file',
    'LBL_REBUILD_DASHLETS_DESC_SUCCESS' => 'Badirra CRM Dashlets cache file rebuilt.',
    'LBL_REBUILD_DASHLETS_DESC' => 'Removing Badirra CRM Dashlets cache and scanning known directories for Badirra CRM Dashlet files.',
    'LBL_REBUILD_DASHLETS_TITLE' => 'Rebuild Badirra CRM Dashlets',
    ...
    'LBL_RETURN' => 'Return',
    'LBL_SEND_STAT' => '<B>Send Anonymous Usage Statistics</B> - If checked, it will send anonymous statistics about your installation to Badirra CRM. every time your system checks for new versions. This information will help us better understand how the application is used and guide improvements to the product.',
    ...
    'LBL_SUITE_UPDATE_TITLE' => 'Badirra CRM Updates',
    ...
    'LBL_UPDATE_TITLE' => 'Badirra CRM Updates',
    'LBL_UPGRADE_TITLE' => 'Repair',
    'LBL_UPGRADE_WIZARD_TITLE' => 'Upgrade Wizard',
    'LBL_UPGRADE_WIZARD' => 'Upload and install Badirra CRM upgrades',
    'LBL_UPGRADE' => 'Check and repair Badirra CRM',
    ...
    'LBL_USERS_DESC' => 'Create, edit, activate and deactivate users in Badirra CRM.',
    ...
    'LBL_MODULEBUILDER_DESC' => 'Build new modules to expand the functionality of Badirra CRM',
    'LBL_SUITEPORTAL' => 'Badirra CRM Portal',
    ...
    'LBL_QUICK_REPAIR_AND_REBUILD_DESC' => 'Repairs and rebuilds DB, Extensions, Vardefs, Badirra CRM Dashlets etc.',
    ...
    'LBL_QR_CBOX_CLEARDASHLET' => 'Clear Badirra CRM Dashlet Cache Data',
    ...
    'LBL_QR_CLEARDASHLET' => 'Clearing Badirra CRM Dashlet files from cache...done',
    ...
    'LBL_QR_CBOX_CLEARSUITEFEEDCACHE' => 'Clear Badirra CRM Feed Cache',
    'LBL_QR_CLEARSUITEFEEDCACHE' => 'Clearing Badirra CRM Feed Cache...done',
    ...
    'ML_RELAX_LOCAL' => 'If you are running Badirra CRM locally, you can relax your Module Loader restrictions to allow the package to be installed.',
    'ML_SUITE_KB' => 'Badirra CRM Knowledge Base',
    'ML_SUITE_DZ' => 'Badirra CRM Developer Zone',
    'ML_AVAIL_RESTRICTION' => 'The available restrictions and exceptions are detailed in the',
    'ML_OVERRIDE_CORE_FILES' => 'Overriding of core Badirra CRM files is not allowed ',
    ...
    'LBL_SAML_HELP_TXT' => 'When SAML authentication is enabled, passwords can only be handled through SAML. None of the Badirra CRM Password Management feature settings will apply.',
    ...
    'LBL_ADMIN_TOOLS_HEADER_DESC' => 'Repair, upgrade and run diagnosis on your Badirra CRM instance',
    ...
    'LBL_REPAIR_UTF_ENCODING_SYNC_PROGRESS_CHECK' => "Running in synchronous mode. This action will take a while. For progress information, please check Badirra CRM logs. Check logs with '[utf-normalize]'",
    ...
    'LBL_SYNC_RUNNING_INFORMATION_LOGS' => "You can also check Badirra CRM logs for more information. Check logs with '[utf-normalize]'",
    'LBL_SYNC_LONG_EXECUTION_WARNING' => 'This action will take a while.',
    'LBL_SYNC_RUN_DESC' => 'Check to run action in synchronous mode. This action will take a while. Please check Badirra CRM logs for progress information. Check logs with \'[utf-normalize]\'',
