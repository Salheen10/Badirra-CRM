...
$mod_strings = array(
    ...
    'LBL_EMAIL_LINK_TYPE_HELP' => '<b>Badirra CRM Mail Client:</b> Send emails using the email client in the Badirra CRM application.<br><b>External Mail Client:</b> Send email using an email client outside of the Badirra CRM application, such as Microsoft Outlook.',
